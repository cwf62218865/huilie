<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-12-21 09:23:22
         compiled from "D:\phpStudy\WWW\huilie\app\template\default\login\index.htm" */ ?>
<?php /*%%SmartyHeaderCode:241055a3b0d0ae23f85-72007499%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ff07f85bc8bd62cf2bcdfa9dcc6f904bf4f20a6b' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\huilie\\app\\template\\default\\login\\index.htm',
      1 => 1513817288,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '241055a3b0d0ae23f85-72007499',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a3b0d0aef6e81_22316324',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a3b0d0aef6e81_22316324')) {function content_5a3b0d0aef6e81_22316324($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'D:\\phpStudy\\WWW\\huilie\\app\\include\\libs\\plugins\\function.url.php';
...
echo $_smarty_tpl->tpl_vars['loginname']->value;
	...
	<?php if (strpos($_smarty_tpl->tpl_vars['config']->value['code_web'],"前台登录")!==false) {?>
	  ...
	  <div class="login_verification">
		...
		<div class="clear"></div>
		<div class="login_box_list logoin_re_m">
		<input id="txt_CheckCode" type="text" class="login_box_bth_yz loginname  loginpyz" value="验证码" maxlength="4" name="authcode"  autocomplete="off"/><div class="login_box_list_yzm"> <img id="vcode_imgs" src="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
