<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-12-21 09:07:05
         compiled from "D:\phpStudy\WWW\huilie\app\template\default\index\index.htm" */ ?>
<?php /*%%SmartyHeaderCode:289725a3b09399f1bc7-07651112%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd1c40de6bcd6136f8402ac7b563e5de8dfb85c24' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\huilie\\app\\template\\default\\index\\index.htm',
      1 => 1513817288,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '289725a3b09399f1bc7-07651112',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a3b0939ba0344_06996986',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a3b0939ba0344_06996986')) {function content_5a3b0939ba0344_06996986($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'D:\\phpStudy\\WWW\\huilie\\app\\include\\libs\\plugins\\function.url.php';
if (!is_callable('smarty_function_listurl')) include 'D:\\phpStudy\\WWW\\huilie\\app\\include\\libs\\plugins\\function.listurl.php';
if (!is_callable('smarty_function_formatpicurl')) include 'D:\\phpStudy\\WWW\\huilie\\app\\include\\libs\\plugins\\function.formatpicurl.php';
...
<?php global $db,$db_config,$config;
        ...
        eval('$paramer=array("namelen"=>"12","comlen"=>"14","rec"=>"\'1\'","limit"=>"20","item"=>"\'rec_list\'","name"=>"\'rec_list1\'","nocache"=>"")
;');
		$ParamerArr = GetSmarty($paramer,$_GET,$_smarty_tpl);
		$paramer = $ParamerArr[arr];
        $Purl =  $ParamerArr[purl];
...
<?php global $db,$db_config,$config;include PLUS_PATH.'/group.cache.php';$plist=array();$rs=null;$nids=null;eval('$paramer=array("pic"=>"1","limit"=>"3","item"=>"\'plist\'","key"=>"\'pkey\'","nocache"=>"")
;');
		$ParamerArr = GetSmarty($paramer,$_GET,$_smarty_tpl);
		$paramer = $ParamerArr['arr'];
		$Purl =  $ParamerArr['purl'];
...
?>
          <li>
              ...
              <div class="green_comename">
              <a href="<?php echo $_smarty_tpl->tpl_vars['hot']->value['curl'];?>
" class="Featured_Jobs_name" target="_blank"><?php echo $_smarty_tpl->tpl_vars['hot']->value['name_n'];?>
</a>
              <?php if ($_smarty_tpl->tpl_vars['hot']->value['ratlogo']) {?><img src="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
/<?php echo $_smarty_tpl->tpl_vars['hot']->value['ratlogo'];?>
" title="<?php echo $_smarty_tpl->tpl_vars['hot']->value['ratname'];?>
"/><?php }?> 
			<?php if ($_smarty_tpl->tpl_vars['rec_list']->value['yyzz_status']==1) {?><img src="<?php echo $_smarty_tpl->tpl_vars['style']->value;?>
/images/disc_icon10.png" title="认证企业"/><?php }?>
              </div>
              <div class="green_jobname">
              <i class="green_jobname_icon">聘</i>
...
" target="_blank" class="green_jobname_a">
              <?php echo $_smarty_tpl->tpl_vars['jlist']->value['name_n'];?>
</a> <?php } ?> </div>
...
"><?php echo mb_substr($_smarty_tpl->tpl_vars['plist']->value['title'],0,20,'gbk');?>
</a></dd>
          </dl>
     <?php } else { ?>
