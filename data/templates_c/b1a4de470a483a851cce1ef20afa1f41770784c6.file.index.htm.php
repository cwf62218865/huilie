<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-12-20 16:31:53
         compiled from "D:\phpStudy\WWW\phpyun\app\template\member\com\index.htm" */ ?>
<?php /*%%SmartyHeaderCode:178355a3a1ff9444b73-35329371%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b1a4de470a483a851cce1ef20afa1f41770784c6' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\phpyun\\app\\template\\member\\com\\index.htm',
      1 => 1509603735,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '178355a3a1ff9444b73-35329371',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a3a1ff965fc70_00372150',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a3a1ff965fc70_00372150')) {function content_5a3a1ff965fc70_00372150($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'D:\\phpStudy\\WWW\\phpyun\\app\\include\\libs\\plugins\\function.url.php';
if (!is_callable('smarty_modifier_date_format')) include 'D:\\phpStudy\\WWW\\phpyun\\app\\include\\libs\\plugins\\modifier.date_format.php';
if (!is_callable('smarty_function_sign')) include 'D:\\phpStudy\\WWW\\phpyun\\app\\include\\libs\\plugins\\function.sign.php';
...
<div class="com_m_index_right">
    <?php if ($_smarty_tpl->tpl_vars['member']->value['status']!=1) {?>
   	<div class="com_index_wsh fltL">
        ...
        <div class="com_index_wsh_box_p">您的帐号尚未通过审核，发布的职位信息将在审核通过后展示。</div>
   		未审核的企业用户无法查看人才简历的联系方式。<br/>
...
<div class="com_m_index_vip_box">
 当前是：<span class="f60"><?php echo $_smarty_tpl->tpl_vars['statis']->value['rating_name'];?>
</span>
   <?php if ($_smarty_tpl->tpl_vars['statis']->value['rating']!='3'&&$_smarty_tpl->tpl_vars['days']->value) {?> &nbsp;&nbsp;&nbsp;
 		会员服务时间：<span class="f60"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['statis']->value['vip_stime'],'%Y-%m-%d');?>
