<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-12-21 08:53:34
         compiled from "D:\phpStudy\WWW\huilie\app\template\member\lietou\joblist.htm" */ ?>
<?php /*%%SmartyHeaderCode:205775a3b060ead8942-88078452%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '64ac66e089e90c531446b9a3839cc666af90c3dc' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\huilie\\app\\template\\member\\lietou\\joblist.htm',
      1 => 1513817289,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '205775a3b060ead8942-88078452',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a3b060ec6aec2_33231441',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a3b060ec6aec2_33231441')) {function content_5a3b060ec6aec2_33231441($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'D:\\phpStudy\\WWW\\huilie\\app\\include\\libs\\plugins\\function.url.php';
...
"><span class="job_list_list_left_name">应聘简历：</span><strong class="job_list_list_left_u"><?php echo $_smarty_tpl->tpl_vars['job']->value['jobnum'];?>
					...
					<span class="com_m_job_lis_zt">已下架</span><a href="javascript:onstatus('<?php echo $_smarty_tpl->tpl_vars['job']->value['id'];?>
','2');" class="com_m_job_lis_hf">【上架】</a>
				    <?php } else { ?> 
					<span class="com_m_job_lis_fb">招聘中</span><a href="javascript:onstatus('<?php echo $_smarty_tpl->tpl_vars['job']->value['id'];?>
','1');"  class="com_m_job_lis_hf">【下架】</a> 
				    <?php }?>  </div>
...
</span> <a href="index.php?c=likeresume&jobid=<?php echo $_smarty_tpl->tpl_vars['job']->value['id'];?>
" class="com_m_job_lis_hf" >查看最新相关简历</a>   </div>
             <div class="job_tg">
             推广服务：
