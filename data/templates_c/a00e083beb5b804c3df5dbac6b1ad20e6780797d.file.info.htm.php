<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-12-21 08:50:13
         compiled from "D:\phpStudy\WWW\huilie\app\template\member\lietou\info.htm" */ ?>
<?php /*%%SmartyHeaderCode:113095a3b0545339cb2-87882867%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a00e083beb5b804c3df5dbac6b1ad20e6780797d' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\huilie\\app\\template\\member\\lietou\\info.htm',
      1 => 1513817289,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '113095a3b0545339cb2-87882867',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a3b0545502d32_85767767',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a3b0545502d32_85767767')) {function content_5a3b0545502d32_85767767($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['ltstyle']->value)."/header.htm", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
              ...
              <li>
                ...
                <div class=textbox>
                  <div class="text_seclet text_seclet_cur2 re">
                    <input id="qypr" class="SpFormLBut text_seclet_w158" type="button" onclick="search_show('job_qypr');" <?php if ($_smarty_tpl->tpl_vars['comclass_name']->value[$_smarty_tpl->tpl_vars['row']->value['pr']]=='') {?> value="请选择猎头性质" <?php } else { ?> value="<?php echo $_smarty_tpl->tpl_vars['comclass_name']->value[$_smarty_tpl->tpl_vars['row']->value['pr']];?>
" <?php }?>  >
              ...
              <li>
                ...
                <div class=textbox>
                  <div class="text_seclet text_seclet_cur3">
                    <input id="mun" class="SpFormLBut text_seclet_w158" type="button" onclick="search_show('job_mun');" <?php if ($_smarty_tpl->tpl_vars['comclass_name']->value[$_smarty_tpl->tpl_vars['row']->value['mun']]=='') {?> value="请选择猎头规模" <?php } else { ?> value="<?php echo $_smarty_tpl->tpl_vars['comclass_name']->value[$_smarty_tpl->tpl_vars['row']->value['mun']];?>
" <?php }?> >
...
>
              ...
              <li>
                ...
                <div class=textbox>
					<div class="text_seclet text_seclet_cur" style="z-index:400">
					<input id="moneytype" class="SpFormLBut text_seclet_w100 " type="button" onclick="search_show('job_moneytype');" <?php if ($_smarty_tpl->tpl_vars['row']->value['moneytype']=='1') {?> value="人民币"  <?php } else { ?> value="美元" <?php }?> >
