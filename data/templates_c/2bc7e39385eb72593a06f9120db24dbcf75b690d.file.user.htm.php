<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-12-21 09:30:01
         compiled from "D:\phpStudy\WWW\huilie\app\template\default\register\user.htm" */ ?>
<?php /*%%SmartyHeaderCode:243995a3b0e99cb4016-51352374%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2bc7e39385eb72593a06f9120db24dbcf75b690d' => 
    array (
      0 => 'D:\\phpStudy\\WWW\\huilie\\app\\template\\default\\register\\user.htm',
      1 => 1513817288,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '243995a3b0e99cb4016-51352374',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a3b0e99dd8f97_44735398',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a3b0e99dd8f97_44735398')) {function content_5a3b0e99dd8f97_44735398($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include 'D:\\phpStudy\\WWW\\huilie\\app\\include\\libs\\plugins\\function.url.php';
  ...
  <div class="logoin_cont fl">
    <div class="reg_h1_tit">
      <ul class="reg_ul_list">
        <li class="<?php if ($_smarty_tpl->tpl_vars['type']->value==1) {?>reg_cur<?php }?>"><a class="reg_h1_icon" href="<?php echo smarty_function_url(array('m'=>'register','usertype'=>1,'type'=>1),$_smarty_tpl);?>
"><i class="reg_h1_icon_i reg_h1_icon_i3 png"></i>用户注册</a></li>
		<?php if ($_smarty_tpl->tpl_vars['config']->value['reg_moblie']=='1') {?>
        <li class="<?php if ($_smarty_tpl->tpl_vars['type']->value==2) {?>reg_cur<?php }?>"><a class="reg_h1_icon" href="<?php echo smarty_function_url(array('m'=>'register','usertype'=>1,'type'=>2),$_smarty_tpl);?>
"><i class="reg_h1_icon_i reg_h1_icon_i1 png"></i>手机注册</a></li>
		<?php }?>
		<?php if ($_smarty_tpl->tpl_vars['config']->value['reg_email']=='1') {?>
        <li class="<?php if ($_smarty_tpl->tpl_vars['type']->value==3) {?>reg_cur<?php }?>"><a class="reg_h1_icon" href="<?php echo smarty_function_url(array('m'=>'register','usertype'=>1,'type'=>3),$_smarty_tpl);?>
...
/app/include/authcode.inc.php"/><span class="reg_yz_look">看不清？
  ...
  <?php if ($_smarty_tpl->tpl_vars['config']->value['reg_real_name_check']=='1') {?>
       ...
       <li class="mt20"><em><font color="#FF0000">*</font> 短信验证：</em>
       <span style="float:left"><input type="text" id="moblie_code" class="logoin_text_yz" onblur="reg_checkAjax('moblie_code');"/>
        <a class="reg_btn_s02_disable" href="javascript:void(0);" id="subreg" onclick="sendmsg('vcodeimg');"><span id="time">获取短信验证</span></a></span>
       <span class="reg_tips reg_tips_red none" id="ajax_moblie_code"></span>
       </li>
   <?php } else { ?>
   <input type="hidden" id="moblie_code" date="1" value="1"/>
...
用户服务协议》</a> ，并自愿遵守该协议。</label>
         ...
         <li class="mt20"><em>&nbsp;</em><input type="button" class="register_submit" <?php if ($_smarty_tpl->tpl_vars['config']->value['reg_real_name_check']=='0') {?> id='subreg' <?php }?> value="立即注册" onclick="check_user(3,'vcodeimg');"/></li>
     </ul>
     </div>
       <?php }?>
     <?php }?>
...
/app/include/authcode.inc.php"/>
           <span class="reg_yz_look">看不清？
  			     <a href="javascript:void(0);" onclick="checkCode('vcode_imgs');" class="registe_a">换一张</a>
           </span>
  			   <span class="reg_tips reg_tips_red none" id="ajax_CheckCode"></span>
  			<?php }?>
		 </li>
     ...
     <?php if ($_smarty_tpl->tpl_vars['config']->value['reg_real_name_check']=='1') {?>
      <li class="mt20">
        ...
        <span style="float:left">
          <input type="text" id="moblie_code" class="logoin_text_yz" onblur="reg_checkAjax('moblie_code');"/>
          <a class="reg_btn_s02_disable" href="javascript:void(0);" id="subreg" onclick="sendmsg('vcode_imgs');"><span id="time">获取短信验证</span></a>
        </span>
        <span class="reg_tips reg_tips_red none" id="ajax_moblie_code"></span>
     </li>
     <?php } else { ?>
...
用户服务协议》</a> ，并自愿遵守该协议。
         ...
         <li class="mt20"><em>&nbsp;</em><input type="button" class="register_submit" <?php if ($_smarty_tpl->tpl_vars['config']->value['reg_real_name_check']=='0') {?> id="subreg" <?php }?> value="立即注册" onclick="check_user('1','vcode_imgs');"/></li>
     </ul>
    </div>
	<?php }?>
        <?php if (strpos($_smarty_tpl->tpl_vars['config']->value['code_web'],"注册会员")!==false) {?>
		 ...
		 <?php } elseif ($_smarty_tpl->tpl_vars['config']->value['code_kind']==3) {?>
		  <input type="hidden" id="code_kind" value="3" />
		  <input id="reset-btn" type="hidden"/>
		  <?php }?>
        <?php } else { ?>
        <input type="hidden" id="code_kind" value="0" />
        <?php }?>
    ...
    <div class="register_right">
                 <div class="register_right_reg">我要招人才<a href="<?php echo smarty_function_url(array('m'=>'register','usertype'=>2,'type'=>1),$_smarty_tpl);?>
">注册企业账户</a></div>
      <div class="register_right_c">

                已有<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_webname'];?>
个人账号 ? <a href="<?php echo smarty_function_url(array('m'=>'login'),$_smarty_tpl);?>
">立即登录</a></div>
